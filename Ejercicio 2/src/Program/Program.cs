...
namespace Program
{
    class Program
    {
        ...
        AppointmentService Appointment1 = new AppointmentService("Steven Jhonson", "986782342", "5555-555-555", DateTime.Now, "Wall Street", "Armand");
        AppointmentService Appointment1 = new AppointmentService("Ralf Manson", "", "5555-555-555", DateTime.Now, "Queen Street", "");
